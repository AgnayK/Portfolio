...
const caseStudies = {
  buTrack: {
    ...
    tabLabel: "Bu-Track",
    title: "Bu-Track",
    role: "Construction Vehicle Management & Work Tracking Platform",
    visual: "phone",
    image: buTrackApp,
    imageAlt: "Bu-Track mobile app preview",
    overview:
      "Bu-Track is a full-stack mobile application designed for construction vehicle owners and contractors to digitally manage daily work operations, vehicle utilization, earnings, and project progress.",
    problem:
      "Construction vehicle owners often rely on notebooks, phone calls, and manual calculations to track work assignments, vehicle usage, payments, and monthly earnings. This makes monitoring multiple vehicles and worksites difficult and increases the risk of errors.",
    approach: [
      "Developed a centralized platform to manage construction vehicles, worksites, and daily operations.",
      "Enabled tracking of ongoing and completed works with daily progress updates.",
      "Supported management of both owned and external vehicles used across projects.",
      "Implemented earnings, expense, and profit tracking for better financial visibility.",
      "Added automated monthly report generation in PDF format.",
      "Provided a Malayalam-friendly user interface to improve accessibility for local users.",
    ],
    outcome: [
      "Reduced dependency on manual record-keeping and phone-based coordination.",
      "Improved visibility into vehicle utilization and project progress.",
      "Simplified monthly accounting and earnings analysis.",
      "Enabled faster decision-making through centralized work and financial data.",
      "Improved operational efficiency for vehicle owners and contractors.",
    ],
    stack: "React Native (Expo), Node.js, Express.js, PostgreSQL, Neon Database, Render, Expo EAS",
  },
  ddcmts: {
    key: "ddcmts",
    tabLabel: "DDCMTS",
    title: "DDCMTS (District Development Committee Minutes Tracking System)",
    role: "Government Meeting Minutes Management System",
    visual: "desktop",
    image: minutes,
    imageAlt: "DDCMTS desktop web application preview",
    overview:
      "DDCMTS is a web-based workflow management system developed for the Kannur District Collectorate to digitize the creation, review, approval, and tracking of official meeting minutes across government departments.",
    problem:
      "Government meeting minutes were traditionally managed through manual processes, making it difficult to track document status, monitor approvals, and maintain a centralized record of discussions and decisions.",
    approach: [
      "Developed a role-based workflow system for managing meeting minutes across multiple administrative levels.",
      "Enabled creation, editing, review, and approval of official meeting records through a structured digital process.",
      "Implemented status tracking to monitor document progress from drafting to final approval.",
      "Centralized storage of meeting records for easier retrieval and reference.",
      "Built an intuitive user interface to simplify daily operations for government officials.",
    ],
    outcome: [
      "Successfully deployed and utilized within the Kannur District Collectorate.",
      "Reduced manual paperwork and improved efficiency in handling official meeting records.",
      "Enhanced transparency and traceability throughout the approval process.",
      "Improved accessibility and organization of government meeting documentation.",
      "Streamlined coordination between different administrative stakeholders.",
    ],
    stack: "React.js, Django REST Framework, PostgreSQL",
  },
};
